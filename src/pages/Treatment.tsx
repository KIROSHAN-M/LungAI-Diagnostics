...
const Treatment = () => {
  ...
  const defaultTreatmentPlan: TreatmentPlan = {
    medications: [
      {
        name: "Remdesivir 200mg IV followed by 100mg",
        instruction: "Administered via intravenous infusion by a healthcare professional",
        frequency: "Once daily",
        duration: "5 days",
      },
      {
        name: "Dexamethasone 6mg",
        instruction: "Take with food to minimize gastric irritation",
        frequency: "Once daily",
        duration: "10 days",
      },
      {
        name: "Albuterol Inhaler (90mcg/puff)",
        instruction: "Inhale 2 puffs for wheezing or shortness of breath",
    ...
    diet: [
      "Increase fluid intake to at least 2-3 liters per day to thin pulmonary secretions",
      "Consume anti-inflammatory foods rich in Omega-3 fatty acids like salmon or walnuts",
      "Maintain adequate Vitamin D and Zinc intake through nutritional sources",
      "Follow a high-protein, calorie-dense diet to support immune recovery",
      "Avoid dairy products if they increase mucus production during coughing episodes",
    ],
    sleepRest: [
      "Practice prone positioning (lying on stomach) to improve oxygenation and lung expansion",
      "Maintain 8 to 10 hours of sleep per night to facilitate cellular repair",
      "Elevate the head of the bed to 30–45 degrees to ease breathing and reduce cough",
      "Avoid physical exertion during the acute phase of infection",
      "Monitor oxygen saturation via pulse oximeter during rest periods",
    ],
    doctorRecommendations: [
      "Immediate isolation protocol following COVID-19 positive clinical correlation",
      "Chest physiotherapy or incentive spirometry 10 times every hour while awake",
      "Daily monitoring of body temperature and oxygen saturation (SpO2)",
      "Repeat chest X-ray in 4-6 weeks to ensure resolution of pneumonia infiltrates",
      "Seek emergency care if experiencing blue lips, confusion, or severe chest pain",
    ],
    lifestyleTips: [
      "Use a HEPA air purifier to minimize dust exposure, a known allergy trigger.",
      ...
      "Sanitize high-touch surfaces regularly to prevent the spread of viral particles.",
    ],
  };
